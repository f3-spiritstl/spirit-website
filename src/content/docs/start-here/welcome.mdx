...
Our region consists of 18 different AOs (Areas of Operation) - 14 regular AOs, two Black Diamond AOs (tougher workouts), one running AO and one rucking AO. You can find out more about each of them, including where they are located and when they meet, on our [locations page](/reference/locations).
